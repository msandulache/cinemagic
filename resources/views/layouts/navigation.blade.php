    ...
    <nav class="relative flex flex-col pt-12 pb-6 px-8 w-full h-full bg-white overflow-y-auto">
        ...
        <div class="flex w-full max-w-xs items-center px-6 border border-coolGray-200 rounded-full">
            <input
                ...
                type="search" placeholder="{{ __('Cauta...') }}">
        ...
        <div class="py-12 mb-auto">
            <ul class="flex-col">
                @guest()
                    <li class="mb-3">
                        <a class="group mr-6 inline-flex items-center text-base" href="{{ route('login') }}">
                            <span class="font-semibold text-rhino-700">{{ __('Intra in cont') }}</span>
                        </a>
                    </li>
                    <li class="mb-12">
                        <a class="group mr-6 inline-flex items-center text-base" href="{{ route('register') }}">
                            <span class="font-semibold text-rhino-700">{{ __('Cont nou') }}</span>
                        </a>
                    </li>
                @endguest
                        ...
                        <li class="mb-3">
                            <a class="group mr-6 inline-flex items-center text-base" href="{{ route('profile.edit') }}">
                              <span class="mr-2 text-purple-400">
                                ...
                                <span class="font-semibold text-rhino-700">{{ __('Contul meu') }}</span>
                            </a>
                        </li>
                        <li class="mb-3">
                            <a class="group mr-6 inline-flex items-center text-base" href="{{ route('account.wishlist') }}">
                              <span class="mr-2 text-purple-400">
                                <svg width="16" height="16" viewbox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                  <g clip-path="url(#clip0_1208_8162)">
                                    <path
                                ...
                                <span class="font-semibold text-rhino-700">{{ __('Favorite') }}</span>
                            </a>
                        </li>
                        <li class="mb-12">
                            <a class="inline-flex items-center text-base text-purple-400 hover:text-purple-200" href="{{ route('account.cart') }}">
                              <span class="mr-2 text-purple-400">
                                ...
                                <span class="font-semibold text-rhino-700">{{ __('Cos de cumparaturi') }}</span>
                            </a>
                        </li>
                @endauth
