<x-app-layout>
    ...
    <section class="py-12 bg-gray-50">
        <div class="container px-4 mx-auto">
            <h1 class="text-center font-heading text-3xl text-coolGray-800 font-semibold mb-10">{{ __('Cos de cumparaturi') }}</h1>
            <div class="bg-white rounded-xl shadow-md p-6 w-full mb-6">
                <div class="overflow-x-auto">
                    <div class="flex w-full">
                        <div class="w-96">
                            <div class="w-full py-4 px-6 h-32 flex items-center">
                                <div class="flex items-center gap-4">
                                    <div class="bg-gray-100 rounded-lg w-36 lg:w-24 h-24 flex items-center justify-center">
                            ...
                            <div class="w-full py-4 px-6 border-b border-coolGray-200 h-32 flex items-center">
                                <div class="flex items-center gap-4">
                                    ...
                                    <div>
                                        <h2 class="text-rhino-800">GrayBlack SportLock</h2>
                                        <p class="text-rhino-300">Lorem ipsum dolor sit amet</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="w-72">
                            <div class="py-4 px-6 h-32 flex items-center justify-center">
                                <p class="text-rhino-800">$129.00</p>
                            </div>
                            <div class="py-4 px-6 border-b border-coolGray-200 h-32 flex items-center justify-center">
                                <p class="text-rhino-800">$99.00</p>
                            </div>
                        </div>
                        <div class="w-72">
                            <div class="py-4 px-6 h-32 flex items-center justify-center">
                                <div class="py-3 px-4 rounded-sm border border-coolGray-200 flex gap-4 items-center bg-white">
                                    ...
                                    <span class="text-rhino-800 text-sm">2</span>
                                    <div class="cursor-pointer text-coolGray-300 hover:text-coolGray-400 transition duration-200">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="17" viewbox="0 0 16 17" fill="none">
                            ...
                            <div class="py-4 px-6 border-b border-coolGray-200 h-32 flex items-center justify-center">
                                <div class="py-3 px-4 rounded-sm border border-coolGray-200 flex gap-4 items-center bg-white">
                                    ...
                                    <span class="text-rhino-800 text-sm">1</span>
                                    <div class="cursor-pointer text-coolGray-300 hover:text-coolGray-400 transition duration-200">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="17" viewbox="0 0 16 17" fill="none">
                                            <path d="M12.6667 7.4998H8.66675V3.4998C8.66675 3.32299 8.59651 3.15342 8.47149 3.02839C8.34646 2.90337 8.17689 2.83313 8.00008 2.83313C7.82327 2.83313 7.6537 2.90337 7.52868 3.02839C7.40365 3.15342 7.33341 3.32299 7.33341 3.4998V7.4998H3.33341C3.1566 7.4998 2.98703 7.57003 2.86201 7.69506C2.73699 7.82008 2.66675 7.98965 2.66675 8.16646C2.66675 8.34327 2.73699 8.51284 2.86201 8.63787C2.98703 8.76289 3.1566 8.83313 3.33341 8.83313H7.33341V12.8331C7.33341 13.0099 7.40365 13.1795 7.52868 13.3045C7.6537 13.4296 7.82327 13.4998 8.00008 13.4998C8.17689 13.4998 8.34646 13.4296 8.47149 13.3045C8.59651 13.1795 8.66675 13.0099 8.66675 12.8331V8.83313H12.6667C12.8436 8.83313 13.0131 8.76289 13.1382 8.63787C13.2632 8.51284 13.3334 8.34327 13.3334 8.16646C13.3334 7.98965 13.2632 7.82008 13.1382 7.69506C13.0131 7.57003 12.8436 7.4998 12.6667 7.4998Z" fill="currentColor"></path>
                                        </svg>
                        ...
                        <div class="w-72">
                            <div class="py-4 px-6 h-32 flex items-center justify-end">
                                <p class="text-rhino-800">$258.00</p>
                            </div>
                            <div class="py-4 px-6 border-b border-coolGray-200 h-32 flex items-center justify-end">
                                <p class="text-rhino-800">$99.00</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="py-4 flex flex-wrap gap-2 justify-between items-center">
                    <p class="text-rhino-700 font-semibold text-lg">Subtotal</p>
                    <p class="text-rhino-800 font-semibold text-lg">$ 357.00</p>
                </div>
            </div>
            <div class="flex justify-end flex-wrap gap-4"><a class="bg-purple-300 py-3 px-4 rounded-sm text-white text-center hover:bg-purple-600 transition duration-200" href="#">{{ __('Goleste cos') }}</a><a class="bg-purple-500 py-3 px-4 rounded-sm text-white text-center hover:bg-purple-600 transition duration-200" href="#">{{ __('Mergi la casa') }}</a></div>
        </div>
    </section>
