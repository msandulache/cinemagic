...
<head>
    ...
    <title>Event Ticket - PageCapture</title>
...
<div class="max-w-7xl mx-auto">
    <div class="flex bg-white m-5">
        <section class="border-gray-100 border-r-4 text-center p-10 border-dashed">
            <span class="block text-5xl font-extrabold text-gray-900">30</span>
            <span class="block text-4xl font-medium text-gray-500 -mt-3">Feb</span>
        </section>

        <section class="flex-1 flex flex-col justify-center px-10">
            <p class="uppercase text-2xl text-bold">
                The Wiggles
            </p>
            <p class="uppercase text-lg font-light">
                Wednesday 29 July 2022
                09:55 am TO 12:00 pm
            </p>
            <p class="uppercase text-lg font-light">
